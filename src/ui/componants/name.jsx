...
export const Name = () => {
	return (
		<div>
			<section
				id="hero"
				className="h-screen w-full bg-black text-white flex flex-col items-center justify-center text-center"
			>
				...
				<h4 className="text-4xl md:text-6xl font-bold mb-4 mt-40">
				...
				<div className="space-x-4">
					<a
						href="#projects"
						className="px-6 py-3 bg-yellow-600 hover:bg-blue-600 rounded-lg"
					>
						View Projects
					</a>
					<a
