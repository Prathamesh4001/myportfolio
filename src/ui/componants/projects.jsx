				...
				<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
					<div class="relative w-full h-48  transition-transform duration-300 hover:scale-105 ">
						...
						<div class="absolute inset-0    flex items-end justify-start text-white text-xl font-bold opacity-0 hover:opacity-100 hover:underline transition-opacity duration-300">
							<p className="w-20 text-yellow-500">
								Real Time Study Platform
								<img
									src="gimage.png"
									alt=""
									className="absolute w-10 h-10 top-0 right-0  transition-opacity hover:opacity-100 hover:z-20"
								/>
							</p>
						</div>
					</div>
					...
					<div class="relative w-full h-48  transition-transform duration-300 hover:scale-105 ">
						...
						<div class="absolute inset-0   flex items-end justify-start text-white text-xl font-bold opacity-0 hover:opacity-100 hover:underline transition-opacity duration-300">
							<p className="w-20 text-yellow-500">
								Machine Accident Protection System{" "}
								<img
									src="gimage.png"
									alt=""
									className="absolute w-10 h-10 top-0 right-0  "
						...
						<div class=" absolute inset-0   flex items-end justify-start text-white text-xl font-bold opacity-0 hover:opacity-100 hover:underline transition-opacity duration-300">
							<p className="w-20 text-yellow-500">
								...
								<img
									src="gimage.png"
									alt=""
									className="absolute w-10 h-10 top-0 right-0 z-0 transition-opacity hover:opacity-100 hover:z-20"
								/>
							</p>
						</div>
					</div>
